      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {resources?.map((resource) => (
          ...
          >
            ...
            <h3 className="text-sm md:text-base font-semibold text-foreground mb-2">{resource?.title}</h3>
            <p className="text-xs md:text-sm text-muted-foreground mb-3 line-clamp-2">{resource?.description}</p>
